...
def infer(
  ...
  with g.as_default():
    ...
    input_error_panel_lt = visualize.error_panel_from_statistics(
        ...
        # Removed the arguments input_lt, and simplify_error_panels - Sina 9-20-18
    ...
    # target_panel_lt = visualize.target_panel_from_statistics(select_channels(predict_target_lt))
    ...
    target_error_panel_lt = visualize.error_panel_from_statistics(select_channels(target_lt), select_channels(predict_target_lt), simplify_error_panels)
        # removed the argument  select_channels(target_lt), and simplify_error_panels - Sina 9-20-18
